  ...
  useEffect(() => {
    ...
    const frag = `
      ...
      vec3 palette(float t) {
        ...
        vec3 b = vec3(0.08, 0.05, 0.20);
        vec3 c = vec3(0.40, 0.20, 0.80);
      ...
      void main() {
        ...
        float o1 = orb(uv, c1, 0.28, 0.30) * 0.6;
        float o2 = orb(uv, c2, 0.22, 0.25) * 0.5;
        float o3 = orb(uv, c3, 0.18, 0.20) * 0.4;
        float om = orb(uv, cm, 0.15, 0.20) * 0.35;

        float combined = o1 + o2 + o3 + om;

        vec3 col = vec3(0.024, 0.024, 0.059); // #06060f base
        col += palette(combined * 0.8 + t * 0.1) * combined * 0.85;
